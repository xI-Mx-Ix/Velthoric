...
val Project.vxEvents get() = requireNotNull(stonecutterBuild.node.sibling("vx-events")) {
    "No common project for $project"
}

val Project.vxNative get() = requireNotNull(stonecutterBuild.node.sibling("vx-native")) {
    "No common project for $project"
}
