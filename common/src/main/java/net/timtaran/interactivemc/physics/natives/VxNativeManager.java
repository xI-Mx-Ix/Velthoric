 ...
 */
package net.timtaran.interactivemc.physics.natives;

import dev.architectury.platform.Platform;
import net.timtaran.interactivemc.physics.Arch;
import net.timtaran.interactivemc.physics.OS;
import net.timtaran.interactivemc.physics.UnsupportedOperatingSystemException;
import net.timtaran.interactivemc.physics.VxNativeLibraryLoader;
