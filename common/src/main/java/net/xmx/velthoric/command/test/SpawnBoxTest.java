...
public final class SpawnBoxTest implements IVxTestCommand {
    ...
    private int spawn(CommandSourceStack source, ServerLevel serverLevel, Vec3 spawnPosMc, com.github.stephengold.joltjni.Vec3 halfExtents) {
