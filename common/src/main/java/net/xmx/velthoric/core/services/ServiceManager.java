...
public class ServiceManager {
    ...
    private volatile Object2ObjectOpenHashMap<Class<? extends IPhysicsService>, IPhysicsService> services;

    private final VxPhysicsWorld physicsWorld;
    private final ServerLevel level;

    public ServiceManager(VxPhysicsWorld physicsWorld, ServerLevel level) {
    ...
    public <T extends IPhysicsService> T registerService(T service) {
        synchronized (this) {
            Object2ObjectOpenHashMap<Class<? extends IPhysicsService>, IPhysicsService> current = services;
            Object2ObjectOpenHashMap<Class<? extends IPhysicsService>, IPhysicsService> newMap;
            ...
            IPhysicsService existing = newMap.put(serviceClass, service);
    ...
    public <T extends IPhysicsService> T getService(Class<T> clazz) {
        Object2ObjectOpenHashMap<Class<? extends IPhysicsService>, IPhysicsService> map = services;

        if (map == null) {
            return null;
        }
        IPhysicsService service = map.get(clazz);
    ...
    public void initialize() {
        ...
        for (IPhysicsService service : map.values()) {
            try {
                service.initialize();
            } catch (Exception e) {
    ...
    public void shutdown() {
        ...
        IPhysicsService[] servicesArray = map.values().toArray(new IPhysicsService[0]);
    ...
    /**
     * Calls {@link IPhysicsService#onPrePhysicsTick(VxPhysicsWorld)} on all services.
     * <p>
    ...
    /**
     * Calls {@link IPhysicsService#onPhysicsTick(VxPhysicsWorld)} on all services.
     * <p>
     * <b>Must be called from:</b> Physics thread
     * <br><b>Frequency:</b> 60Hz (fixed timestep)
     */
    ...
    /**
     * Calls {@link IPhysicsService#onGameTick(ServerLevel)} on all services.
     * <p>
