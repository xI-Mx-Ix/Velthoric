 ...
 * settings without needing direct access to the physics world or object manager.
 */
@FunctionalInterface
public interface VxRigidBodyFactory {
    /**
     * Creates a Jolt body from the given settings and adds it to the physics world.
     * The implementation of this method (within VxObjectManager) is responsible for
