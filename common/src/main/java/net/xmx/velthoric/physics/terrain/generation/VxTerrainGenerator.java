...
/**
 * Generates triangle mesh physics shapes from chunk block data.
 * It uses a greedy meshing algorithm to optimize the geometry and caches the results
 * both in memory and on disk to improve performance.
 *
 * @author xI-Mx-Ix
 */
public final class VxTerrainGenerator {
    ...
    private ShapeRefC generateShapeFromVoxels(ServerLevel level, VxChunkSnapshot snapshot) {
