...
/**
 * Client-side representation of a car. Handles rendering of the chassis and wheels
 * based on interpolated physics states.
 *
 * @author xI-Mx-Ix
 */
public class VxClientCar extends VxClientVehicle {

    public VxClientCar(UUID id, ResourceLocation typeId, VxClientObjectManager manager, int dataStoreIndex, EBodyType objectType) {
