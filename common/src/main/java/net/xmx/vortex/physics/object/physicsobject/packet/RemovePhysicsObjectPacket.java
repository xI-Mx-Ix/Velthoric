...
public class RemovePhysicsObjectPacket {
    ...
    public static void handle(RemovePhysicsObjectPacket msg, Supplier<NetworkManager.PacketContext> contextSupplier) {
        NetworkManager.PacketContext context = contextSupplier.get();
        context.queue(() -> ClientPhysicsObjectManager.getInstance().removeObject(msg.id));
    }
}