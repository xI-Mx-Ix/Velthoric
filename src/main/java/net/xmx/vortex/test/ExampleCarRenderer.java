...
import net.xmx.vortex.model.objmodel.OBJModel;

public class ExampleCarRenderer extends EntityRenderer<ExampleCarEntity> {

    private static final ResourceLocation MODEL_LOCATION = ResourceLocation.tryBuild("vortex", "obj/acura_mdx_yd1.obj");
    private static final ResourceLocation TEXTURE_LOCATION = ResourceLocation.tryBuild("vortex", "obj/acura_mdx_yd1.png");
