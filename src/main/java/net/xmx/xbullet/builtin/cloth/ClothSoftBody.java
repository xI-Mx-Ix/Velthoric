...
public class ClothSoftBody extends SoftPhysicsObject {
    ...
    public ClothSoftBody(UUID physicsId, Level level, PhysicsTransform initialTransform, IPhysicsObjectProperties properties,
    ...
    public ClothSoftBody(UUID physicsId, Level level, String typeId, PhysicsTransform initialTransform, IPhysicsObjectProperties properties, @Nullable FriendlyByteBuf initialData) {
