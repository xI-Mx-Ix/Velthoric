...
public final class SpawnHingePairCommand {
    ...
    private static int execute(CommandContext<CommandSourceStack> context) throws CommandSyntaxException {
        ...
        ObjectManager objectManager = PhysicsWorld.getObjectManager(serverLevel.dimension());
        ...
        IPhysicsObject iBox1 = objectManager.createPhysicsObject(BoxRigidPhysicsObject.TYPE_IDENTIFIER, UUID.randomUUID(), serverLevel, new PhysicsTransform(pos1, Quat.sIdentity()), null);
        ...
        IPhysicsObject iBox2 = objectManager.createPhysicsObject(BoxRigidPhysicsObject.TYPE_IDENTIFIER, UUID.randomUUID(), serverLevel, new PhysicsTransform(pos2, Quat.sIdentity()), null);
