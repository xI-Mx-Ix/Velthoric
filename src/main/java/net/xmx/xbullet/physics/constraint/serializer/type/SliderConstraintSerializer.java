    ...
    public CompletableFuture<TwoBodyConstraint> createAndLink(CompoundTag tag, ConstraintManager constraintManager, PhysicsObjectManager objectManager) {
        ...
        return CompletableFuture.allOf(future1, future2).thenApplyAsync(v -> {
            ...
            try (SliderConstraintSettings settings = new SliderConstraintSettings()) {
                ...
                settings.setSliderAxis1(NbtUtil.getVec3(tag, "sliderAxis1"));
                settings.setSliderAxis2(NbtUtil.getVec3(tag, "sliderAxis2"));
                ...
                if (constraint != null) {
                    constraint.setTargetPosition(tag.getFloat("targetPosition"));
