...
public class StateSnapshot {
    ...
    public final PhysicsTransform transform = new PhysicsTransform();
    @Nullable public final Vec3 linearVelocity;
    @Nullable public final Vec3 angularVelocity;
    @Nullable public float[] vertexData;
    ...
    public StateSnapshot set(long timestamp, PhysicsTransform transform, @Nullable Vec3 linVel, @Nullable Vec3 angVel, @Nullable float[] vertices, boolean isActive) {
