...
import net.xmx.xbullet.physics.object.physicsobject.persistence.ObjectStorage;
...
public class ObjectDataSystem {
        ...
        for (UUID id : new ObjectArrayList<>(idsToLoad)) {
            ...
            CompletableFuture.runAsync(() -> {
                try {
                    ...
                    if (obj == null) {
                        XBullet.LOGGER.error("Factory for {} returned null object.", typeId);
                        return;
                    }
                    ...
                    XBullet.LOGGER.error("Failed to load physics object {}", id, e);
                }
            }, loadingExecutor);
        }
    ...
    public void unloadObjectsInChunk(ChunkPos chunkPos) {
        ...
        new ObjectArrayList<>(objectManager.getManagedObjects().values()).forEach(obj -> {
            PhysicsTransform transform = obj.getCurrentTransform();
    ...
    public CompletableFuture<IPhysicsObject> loadObject(UUID id) {
        ...
        return CompletableFuture.supplyAsync(() -> {
            ...
            try {
                ...
                XBullet.LOGGER.error("Failed to load physics object for constraint dependency {}", id, e);
                return null;
            }
