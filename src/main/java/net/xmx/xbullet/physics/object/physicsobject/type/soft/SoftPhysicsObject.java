...
public abstract class SoftPhysicsObject extends AbstractPhysicsObject {
    ...
    protected SoftPhysicsObject(UUID physicsId, Level level, String objectTypeIdentifier, PhysicsTransform initialTransform, IPhysicsObjectProperties properties) {
            ...
            if (settingsTarget != null) {
                if (lastSyncedVertexData != null && lastSyncedVertexData.length > 0) {
                    ...
                    if (vertices != null && vertices.length * 3 == lastSyncedVertexData.length) {
                        ...
                        XBullet.LOGGER.warn("Vertex data length mismatch for soft body {}. Saved: {}, Expected: {}", physicsId, lastSyncedVertexData.length, vertices.length * 3);
                    }
                }
